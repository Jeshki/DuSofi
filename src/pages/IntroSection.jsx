    ...
    <section className="bg-white dark:bg-very-dark-gray text-gray-800 dark:text-gray-300 py-16 px-6 sm:px-12 lg:px-24 transition-colors duration-300 uppercase"> {/* Adjusted text colors */}
      ...
      <div className="max-w-4xl mx-auto space-y-8 text-lg leading-relaxed font-serif">
        <p className="flex items-start gap-4"> {/* Increased gap */}
          ...
          <FaQuoteLeft className="mt-1 text-indigo-600 dark:text-indigo-400 text-xl shrink-0" /> {/* Changed icon color */}
        ...
        <p className="flex items-start gap-4">
          <FaFeatherAlt className="mt-1 text-indigo-600 dark:text-indigo-400 text-xl shrink-0" /> {/* Changed icon color */}
        ...
        <p className="flex items-start gap-4">
          <FaRegLightbulb className="mt-1 text-indigo-600 dark:text-indigo-400 text-xl shrink-0" /> {/* Changed icon color */}
