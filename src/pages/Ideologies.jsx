  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-12 relative">
        ...
        {ideologies.map((ideology) => (
          ...
          >
            ...
            <div className="mt-6 text-center">
              ...
              >
                View Philosophers in this group
              </button>
            </div>
          </div>
        ))}
      ...
      <p className="mt-8 text-center text-gray-500 dark:text-gray-400">
        This page provides a description of major philosophical ideologies. To learn more about specific philosophers associated with these ideologies, please explore the philosophers list section.
      </p>
      ...
      {showBackToTop && (
        <button
          onClick={backToTop}
          className="fixed bottom-6 right-6 bg-rose-900 text-white p-3 rounded-full shadow-lg hover:bg-rose-900 transition-transform duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-rose-800 focus:ring-offset-2 dark:focus:ring-offset-black"
